...
When configuring the web servers, you will reference the specific certificate files stored at that path in a folder generated by the service for a specified certificate name.
...
After, you have installed the Windows Service and renewed certificates have been downloaded to the specified folder. Please follow the links below to configure your web server to use the certificates :
