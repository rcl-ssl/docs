...
- Open the [Github Project Page ](https://github.com/rcl-ssl/V8_RCL.SSL.AutoRenew.Function) for the AutoRenew function , and in the **master** branch, click on the 'Deploy to Azure' button on the **README** page
